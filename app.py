...
from reservations.models import Event,Period,Appointment,Location
...
def _before():
    ...
    g.admin.register(Event,
            url_for('event.display'),
            display_name='Events',
            top_level=True,
            minimum_rank_required=500,
        )
    g.admin.register(Location,
...
# # add more modules...
from reservations.views import event, location
